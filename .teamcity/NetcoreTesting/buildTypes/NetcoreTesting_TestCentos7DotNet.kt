...
object NetcoreTesting_TestCentos7DotNet : BuildType({
    templates(_Self.buildTypes.DotNetTesting)
    name = "Test: Centos 7 - DotNet"
    ...
    requirements {
        ...
        equals("system.Octopus.OS", "CentOS", "RQ_186")
        equals("system.Octopus.Purpose", "Test", "RQ_276")
    }
})
