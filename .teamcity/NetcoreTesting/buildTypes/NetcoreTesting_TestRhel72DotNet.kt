...
object NetcoreTesting_TestRhel72DotNet : BuildType({
    templates(_Self.buildTypes.DotNetTesting)
    name = "Test: RHEL 7.2 - DotNet"
    ...
    requirements {
        ...
        equals("system.Octopus.OS", "RHEL", "RQ_186")
        equals("system.Octopus.OSVersion", "7.2", "RQ_190")
    }
})
