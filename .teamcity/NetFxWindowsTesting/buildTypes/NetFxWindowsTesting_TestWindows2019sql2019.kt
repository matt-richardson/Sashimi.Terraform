...
object NetFxWindowsTesting_TestWindows2019sql2019 : BuildType({
    templates(_Self.buildTypes.DotNetTesting)
    name = "Test: Windows 2019 - SQL 2019"
    ...
    requirements {
        equals("system.Octopus.OSVersion", "2019", "RQ_91")
        equals("system.Octopus.SqlVersion", "2019", "RQ_86")
        equals("system.Octopus.Purpose", "Test", "RQ_45")
